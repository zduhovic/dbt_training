...
final as (
    ...
    select
        ...
        customers_and_locations_joined.city_name city_name,
        customers_and_locations_joined.state_name state_name,
        customers_and_locations_joined.zip_code zip_code,
